...
$lang['hasstatictitle'] = 'Use a static HTML <tt>&lt;title&gt;</tt> header element (if the template supports this)<br>Note: Use this only in special cases. Leave off normally.';
$lang['statictitle'] = 'Use this as the static HTML <tt>&lt;title&gt;</tt> header element (if <span lass="outkey"><a href="https://www.dokuwiki.org/config:hasstatictitle">hasstatictitle</a></span> is on and the template supports this). Leave empty to use the <span lass="outkey"><a href="https://www.dokuwiki.org/config:title">title</a></span> setting.<br>Don\'t use HTML tags. They would appear literally.';
