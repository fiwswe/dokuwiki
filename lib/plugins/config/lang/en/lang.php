...
$lang['statictitle'] = 'Use this as the static HTML <title> header element (if hasstatictitle is on and the template supports this). Empty defaults to the title setting';
