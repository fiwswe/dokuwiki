...
$lang['hasstatictitle']        = 'Konstantes HTML <tt>&lt;title&gt;</tt> Header-Element verwenden (wenn das Template dies unterstützt)';
$lang['statictitle']           = 'Festes HTML <tt>&lt;title&gt;</tt> Header-Element mit diesem Inhalt (wenn <span class="outset"><a href="https://www.dokuwiki.org/config:hasstatictitle">hasstatictitle</a></span> an ist und das Template dies unterstützt). Wenn leer wird der Wert aus der <span class="outset"><a href="https://www.dokuwiki.org/config:title">title</a></span>-Einstellung verwendet.<br>HTML Tags sollten nicht verwendet werden, da sie wörtlich dargestellt würden.';
