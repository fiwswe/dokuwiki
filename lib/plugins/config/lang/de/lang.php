...
$lang['hasstatictitle']        = 'Konstantes HTML <tt>&lt;title&gt;</tt> Header-Element verwenden (nur, wenn vom Template unterstützt)';
$lang['statictitle']           = 'Festes HTML <tt>&lt;title&gt;</tt> Header-Element mit diesem Inhalt (nur, wenn <span class="outkey"><a href="https://www.dokuwiki.org/config:hasstatictitle">hasstatictitle</a></span> an ist und vom Template unterstützt). Wenn leer wird der Wert aus der <span class="outkey"><a href="https://www.dokuwiki.org/config:title">title</a></span>-Einstellung verwendet.<br>HTML Tags sollten nicht verwendet werden, da sie wörtlich dargestellt würden.';
